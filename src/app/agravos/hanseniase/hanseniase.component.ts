...
@Component({
  selector: 'app-hanseniase',
  templateUrl: './hanseniase.component.html',
  styleUrls: ['./hanseniase.component.scss']
})
export class HanseniaseComponent {
  form!: FormGroup;
  submitted = false;
  ...
  private dependenciesMap: Record<string, string> = {
    'Texto3': 'Texto2',   // Observa 'Texto2' para ativar 'Texto3'
    'Texto4': 'Texto3',
    'Texto5': 'Texto4',
    'Texto6': 'Texto5'
  };
  ...
  private createForm() {
    ...
    for (let i = 1; i <= 127; i++) {
      let validators = [];
      const requiredFields = [2,3,5,6,8,9,12,18,19,33,38,40,41,42,43,44];
  ...
  async onSubmit() {
    ...
    const formValues = this.form.value;
      ...
      // Carregue seu PDF
      const pdfUrl = '../../../assets/formularios/Hanseniase.pdf'; // Altere isso para o caminho do seu PDF
