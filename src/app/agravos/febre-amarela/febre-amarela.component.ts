...
@Component({
  selector: 'app-febre-amarela',
  templateUrl: './febre-amarela.component.html',
  styleUrls: ['./febre-amarela.component.scss']
})
export class FebreAmarelaComponent {
  form!: FormGroup;
  submitted = false;
  ...
  private dependenciesMap: Record<string, { observe: string, value?: any }> = {
    ...
    'Texto42': { observe:'Texto41'},
    'Texto43': { observe:'Texto42'},
    'Texto44': { observe:'Texto43'},
    'Texto45': { observe:'Texto44'},
    'Texto53': { observe:'Texto52'},
    'Texto54': { observe:'Texto53'},
    'Texto55': { observe:'Texto54'},
    'Texto56': { observe:'Texto55'},
    'Texto73': { observe:'Texto72', value:'3'},
    'Texto78': { observe:'Texto76'},
    'Texto79': { observe:'Texto78'},
  };
  ...
  private createForm() {
    ...
    for (let i = 1; i <= 108; i++) {
      let validators = [];
      const requiredFields = [2,3,5,6,8,9,12,18,19,33,34,39,50,72,75,77,78,79,87];
  ...
  async onSubmit() {
    ...
    const formValues = this.form.value;
      ...
      // Carregue seu PDF
      const pdfUrl = '../../../assets/formularios/Febre_Amarela.pdf'; // Altere isso para o caminho do seu PDF
